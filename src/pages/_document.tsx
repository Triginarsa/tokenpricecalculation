  ...
  render() {
    ...
    return (
      <Html lang="en" data-theme={randomValue}>
        ...
        <meta property="og:image" content="https://i.ibb.co/ZHKxSbn/Screenshot-2023-06-06-at-01-52-33.png" />
        ...
        <meta property="twitter:image" content="https://i.ibb.co/ZHKxSbn/Screenshot-2023-06-06-at-01-52-33.png" />
        <body>
          <Main />
          <NextScript />
        </body>
